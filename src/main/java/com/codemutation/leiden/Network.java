package com.codemutation.leiden;
...
import com.codemutation.leiden.util.LargeBooleanArray;
import com.codemutation.leiden.util.LargeDoubleArray;
import com.codemutation.leiden.util.LargeIntArray;
import com.codemutation.leiden.util.LargeLongArray;
...
public class Network implements Serializable
{
    ...
    {
        return com.codemutation.leiden.util.Arrays.calcSum(nodeWeights);
    }
    ...
    public Network createNetworkWithoutNodeWeights()
    {
        ...
        networkWithoutNodeWeights.nodeWeights = com.codemutation.leiden.util.Arrays.createDoubleArrayOfOnes(nNodes);
    ...
    public Network createNetworkWithoutNodeAndEdgeWeights()
    {
        ...
        networkWithoutNodeAndEdgeWeights.nodeWeights = com.codemutation.leiden.util.Arrays.createDoubleArrayOfOnes(nNodes);
    ...
    public Network createNormalizedNetworkUsingAssociationStrength()
    {
        ...
        normalizedNetwork.nodeWeights = com.codemutation.leiden.util.Arrays.createDoubleArrayOfOnes(nNodes);
	...
	this.neighbors.resize(nEdges); this.neighbors.shrink();
        ...
        this.nodeWeights = (nodeWeights != null) ? nodeWeights.clone() : (setNodeWeightsToTotalEdgeWeights ? getTotalEdgeWeightPerNodeHelper() : com.codemutation.leiden.util.Arrays.createDoubleArrayOfOnes(nNodes));
