package com.codemutation.leiden.util;
...
class LargeLongArrayTest
{
    ...
    void ensureCapacity()
    {
        ...
        assertEquals(a.capacity(), c * (1 + LargeLongArray.RELATIVE_CAPACITY_INCREASE));
    }
    ...
    void binarySearch()
    {
        ...
        {
            x = (long)(a.get(i) / 2.0 + a.get(i - 1) / 2.0);
            j = a.binarySearch(x);
    ...
    {
        long i = a.size() / 3;
        for (long x : a.fromTo(i, i + a.size() / 3))
            assertEquals(x, a.get(i++));
    }
    ...
    {
        Random r = new Random(0);
        LargeLongArray a2 = new LargeLongArray(a.size() / 2);
    ...
    void copyOfRange()
    {
        ...
        LargeLongArray a2 = a.copyOfRange(from, to);
